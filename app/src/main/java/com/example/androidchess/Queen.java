...
public class Queen extends Piece{
    ...
    /**
     * Queen class for creating both white and black Queens
     * @param type String
     * @param space Space
     */
    public Queen(String type, Space space, Drawable x) {
        super(type, space, x);
    }
    ...
    public void calculateMoves() {
        ...
        String [] tmpMoves;
        String [] basicMoves = new String[37];
        ...
        for(int i = row + 1; i <= 8; i++) {
            ...
            basicMoves[index++] = movesUp;
        }
        basicMoves[index++] = "||";
        for(int i = row - 1; i >= 1; i--) {
            String movesDown = column + Integer.toString(i);
            basicMoves[index++] = movesDown;
        }
        basicMoves[index++] = "||";
        char tmp = ++column;
        --column;
